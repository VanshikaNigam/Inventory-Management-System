...
<%@ page import="controller.SaleDateServlet"%>
...
<html lang="en">
	...
	<head>
		...
		function validate()
		{
			var date1=document.forms["SaleF"]["rt"].value;
			var date2=document.forms["SaleF"]["rt"].value;
			ifdate1=="")
			{
...
<h3 class="menu" align="right"><font color="white">
	...
	<h4 align="center"><u>Sales Report</u></h4>
			...
			<br>
				...
				double earning=0.0;
				%>
				<form action="SaleDateServlet" method="post">
					...
					<table align="center" width="80%" border="2">
						...
						<tr><td>Total Collection:</td><td><%=earning%></td></tr>
