<!DOCTYPE html>
<%@ page import="bean.ReturnForm"%>
<%@ page import="controller.StockRServlet"%>
<html lang="en">
...
<body>
	...
	<div class="wrap">
		...
		<form action="StockRServlet" method="post" name="StockRe">

			<table align="center">


				<%
							ReturnForm returnForm = (ReturnForm) request
				...
				<tr>
					...
					<td><input type="text" name="articleno"
						placeholder="article no" value="<%out.print(articleno);%>"></td>
					<td>Name</td>
				...
				<tr>
					...
					<td><input type="text" name="articleno"
						...
						value="<%out.print(returnForm.getArticleno());%>"></td>
					<td>Name</td>
					<td><input type="text" name="Name"
						placeholder="items returned"
						value="<%out.print(returnForm.getName());%>" readonly></td>
				</tr>
				<tr>
					<td>Sale Rate</td>
					<td><input type="text" name="salerate" placeholder="rate"
						value="<%out.print(returnForm.getSalerate());%>" readonly></td>
					<td>Quantity</td>
					<td><input type="text" name="quantity" placeholder="items"
						value="<%out.print(returnForm.getQuantity());%>" readonly></td>
				</tr>
				<tr>
					<td>SalePerson</td>
					<td><input type="text" name="saleperson" placeholder="name"
						value="<%out.print(returnForm.getSaleperson());%>" readonly></td>
					<td>Date</td>
					<td><input type="date" name="Date"
						value="<%out.print(returnForm.getDate());%>" readonly></td>
				</tr>
				<tr>
