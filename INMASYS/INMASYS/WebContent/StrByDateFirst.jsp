...
<html lang="en">
	...
	<head>
		...
		function validate() {
			var date1 = document.forms["StockByDate"]["date1"].value;
			var date2 = document.forms["StockByDate"]["date2"].value;
...
<h3 align="right"><font color="white">
	...
	<br><br>
	<h4 align="center"><u>Stock Report By Date</u></h4>
	<br>
	<br>
				
				<form action="StrByDate" method="post" name="StockByDate">
					<table width="600">
						<tr>
							<td>FROM:</td>
